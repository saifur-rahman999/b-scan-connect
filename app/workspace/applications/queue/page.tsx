...
export default async function ApplicationQueuePage() {
  ...
  const applications = await listApplicationQueue(actor);
  return <div className="member-page"><OperationsNav active="applications" role={actor.role as "ADMIN"|"REFERRAL_OFFICER"|"ORG_REP"}/><main id="main-content" className="shell member-main">
